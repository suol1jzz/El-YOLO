In this paper, open source datasets HRSID and VisDrone2019 are used in the research process.In this thesis, HRSID (High Resolution SAR Images Dataset) is a dataset for the tasks of ship detection, semantic segmentation, and instance segmentation in high-resolution synthetic aperture radar (SAR) images. This project is mainly used for research and development of deep learning based ship detection and segmentation techniques.The main programming language of the HRSID project is Python, which is suitable for data processing and deep learning model development using Python.VisDrone2019 (UAV) is one of the most widely used datasets, renowned for its standardized and challenging nature. It consists of images captured by drones in real-world scenarios, covering various angles, altitudes, and resolutions, including both daytime and nighttime scenes. The dataset is divided into three subsets: 6,471 images for training, 548 images for validation, and 1,580 images for testing. They are available for download at the address below:

The HRSIFD dataset is available for download at:https://github.com/chaozhong2010/HRSID

The VisDrone2019 dataset is available for download at:https://gitcode.com/gh_mirrors/of/Official-SSDD/blob/main/README.md?utm_source=csdn_github_accelerator&isLogin=1](https://github.com/VisDrone/VisDrone-Dataset
